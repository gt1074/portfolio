import {Group, Scene, Color, DirectionalLight, AmbientLight, PerspectiveCamera, WebGLRenderer, LoadingManager} from "three"
...
function init() {
    scene = new Scene();
    scene.background = new Color( '#F2E9DC' );
